            ...
            for dest_dir in self.destination_dirs:
                try:
                    ...
                    if os.path.exists(src_full_dest_path):
                        ...
                        print(f"Renamed {src_relative_path} to {dest_relative_path} in {dest_dir}")
                except Exception as e:
                    print(f"Error renaming {src_relative_path} to {dest_relative_path} in {dest_dir}: {e}")
...
for i in range(1, 6):
    ...
    button_browse_target = tk.Button(frame_target,
                                      text="Browse",
                                      command=lambda e=entry_target: browse_directory(e))
